...
日期：2026-09-17 建立，2026-09-18 补充人偶、VACE、稳定性、颜色实验，2026-09-20 整理。状态：**线稿控制、角色参考、双人、对话均已验证；日常使用请走 docs/shot-pipeline.md 的镜头流水线，本文是实现记录与全部对照实验。** 基线冻结见 `baselines/comfyui-v1/BASELINE.md`。
